...
img = cv2.imread(r"C:\Users\YAVUZ\Desktop\tespit\sa.jpg")
#print(img)
...
model = cv2.dnn.readNetFromDarknet(r"C:\Users\YAVUZ\Desktop\tespit\yolov4.cfg",r"C:\Users\YAVUZ\Desktop\tespit\yolov4_lasto.weights")
...
for detection_layer in detection_layers:
    for object_detection in detection_layer:
                ...
                if confidence > 0.55: # güven skoru bu değerlerden büyükler için işlem devam edecek
...
for max_id in max_ids: # liste içindeki değeri çekeceğiz
            ...
            print("Endemik Bitki Tespiti {}".format(label))
